  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-gray max-w-none space-y-6 text-gray-600">
        <p>
          By using Indegenius, you agree to these Terms of Use. Please read them carefully.
        </p>
        <h2 className="text-lg font-semibold text-gray-900">Eligibility</h2>
        <p>
          Indegenius is open to students, researchers, and intellectuals with a connection to Africa.
          You must be at least 16 years old to create an account.
        </p>
        <h2 className="text-lg font-semibold text-gray-900">Content Ownership</h2>
        <p>
          You retain ownership of all content you publish on Indegenius. By publishing, you grant us
        ...
        <p>
          The Indegenius platform design, logo, and codebase are the property of Indegenius. Do not
        ...
        <p>
          ...
          <a href={`mailto:${CONTACT_EMAILS.legal}`} className="text-emerald-brand hover:underline">
