...
export default function HomeGuestNotice() {
  ...
  return (
    <div className="mb-4 flex items-center gap-3 rounded-[10px] border border-green-wash-border bg-green-tint px-3.5 py-3">
      <p className="min-w-0 flex-1 text-[13px] leading-[1.5] text-ink sm:text-[13.5px]">
