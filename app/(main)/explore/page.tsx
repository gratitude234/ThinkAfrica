...
function DiscoverTabs({
  ...
  return (
    <div className="sticky top-[var(--app-nav-height)] z-30 -mx-4 mb-5 max-w-[calc(100%+2rem)] overflow-x-auto border-b border-gray-200 bg-canvas/95 px-4 pt-1 backdrop-blur [scrollbar-width:none] sm:-mx-6 sm:mb-6 sm:max-w-[calc(100%+3rem)] sm:px-6 lg:mx-0 lg:max-w-full lg:px-0 [&::-webkit-scrollbar]:hidden">
...
function DiscoverAside({
  ...
  return (
    <aside className="hidden space-y-4 lg:sticky lg:top-[calc(var(--app-nav-height)+1rem)] lg:block">
