          ...
          <>
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-500">
                It&apos;s now visible to the entire ThinkAfrica community.
              </p>
          ...
          <>
            ...
            <div className="mt-8 rounded-2xl bg-gray-50 p-4">
              ...
              <p className="mt-2 text-sm leading-relaxed text-gray-500">
                Our editorial team reviews every submission within 24-48 hours.
                You&apos;ll get a notification when your post goes live.
              </p>
            </div>
