/**
 * Compares search PostgREST reads with search PostgreSQL reads,
...
const REQUIRED = [
  ...
  ["NEXT_PUBLIC_SUPABASE_ANON_KEY", "the anon key, so the PostgREST side is subject to RLS"],
...
if (missing.length) {
  console.error("\nCannot run the viewerDomains parity check. Missing:\n");
...
const result = spawnSync(
  ...
  [
    ...
    "run",
    "lib/db/viewerDomains.parity.live.test.ts",
    "--reporter=verbose",
  ],
  {
    stdio: "inherit",
