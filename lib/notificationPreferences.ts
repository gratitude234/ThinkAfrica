 ...
 *
 * 1. Only *non-actionable* types can be muted. You can turn off the noise — likes,
 *    follows, publication announcements — but never something that asks you to do
 *    something, and never a moderation or account notice. `assertMutableTypes()`
 *    holds the line; a test calls it so widening a group to something actionable
 *    fails the suite rather than quietly letting a suspension be silenced.
 *
...
export const IN_APP_PREF_GROUPS: InAppPrefGroup[] = [
  ...
  {
    key: "inapp_publications",
    label: "New publications",
    description:
      "When an author you follow, or a topic you subscribe to, publishes something",
    types: ["author_published", "topic_published"],
  },
  {
    key: "inapp_debates",
